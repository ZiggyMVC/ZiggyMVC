<div class="row">
	<div class="col-md-12">
		<p>Ziggy - leverages Application.cfc and some simple conventions to provide a 'full' MVC framework in a single file.</p>
		<p>Intended to require near-zero configuration, Ziggy lets you build your application without worrying about a framework getting in your way.</p>
