<cfoutput>
	<form name="userForm" id="userForm" method="post" action="#buildUrl('main.change')#">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td><input type="password" name="currentPassword" id="currentPassword" size="25" required="yes" message="Please enter your current password" /></td>
			</tr>
			<tr>
				<td><strong><label for="newPassword" class="label">New Password:</label></strong></td>
				<td><input type="password" name="newPassword" id="newPassword" size="25" required="yes" message="Please enter your new password" /></td>
			</tr>
			<tr>
				<td><strong><label for="retypePassword" class="label">Retype New Password:</label></strong></td>
				<td><input type="password" name="retypePassword" id="retypePassword" size="25" required="yes" message="Please retype your new password" /></td>
			</tr>
		</table>
